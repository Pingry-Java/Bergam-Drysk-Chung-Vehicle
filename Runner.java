...
public class Runner
{
	public static void main(String[] args)
	{
		...
		System.out.println("Please choose which vehicle you'd like to take on this trip (the vehicle used affects gas capacity, speed, passenger capacity, and cargo capacity): [CAR][TRUCK][MOTORCYCLE][BUS]"); 
		...
		else if ((whichVehicle.toUppercase).equals("TRUCK"))
			vehicle = new Truck(); 
		else
